Sprint 18.9 - Build and Validation (colcon)
============================================
...
Build and validate the Sprint 18 ``lifecore_state_msgs`` package using
``colcon``.
...
10. Generated interfaces are importable/visible according to normal ROS 2
    tooling if the environment allows it.
...
If the environment does not support full ROS 2 build, document exactly what
